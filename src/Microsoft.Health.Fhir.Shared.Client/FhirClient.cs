...
namespace Microsoft.Health.Fhir.Client
{
    public class FhirClient : IFhirClient
    {
        ...
        public FhirClient(NirvanaHealth.Fhir.Fhir fhir, string proxyServ, ResourceFormat format = ResourceFormat.Json)
        {
        ...
        public Task<FhirResponse<Patient>> SearchPatientAsync(ResourceType resourceType, string query = null, int? count = null, CancellationToken cancellationToken = default)
        {
            var sb = new StringBuilder();
           ...
           // sb.Append(resourceType);//.Append('?');
            ...
            return SearchPatientAsync(sb.ToString(), null, cancellationToken);
        }

        public async Task<FhirResponse<Patient>> SearchPatientAsync(string url, CancellationToken cancellationToken = default)
        {
            return await SearchPatientAsync(url, null, cancellationToken);
        }

        public async Task<FhirResponse<Patient>> SearchPatientAsync(string url, Tuple<string, string> customHeader, CancellationToken cancellationToken = default)
        {
            ...
            return await CreateResponseAsync<Patient>(response);
        }
