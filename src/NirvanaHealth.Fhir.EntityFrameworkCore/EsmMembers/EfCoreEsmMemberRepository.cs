...
{
    public class EfCoreEsmMemberRepository : EfCoreRepository<FhirDbContext, EsmMember, string>, IEsmMemberRepository
    {
        public EfCoreEsmMemberRepository(IDbContextProvider<FhirDbContext> dbContextProvider)
        ...
        {
            var query = ApplyFilter((await GetQueryableAsync()), filterText, mCPMember_IDMin, mCPMember_IDMax, lastName, firstName, mIddleName, suffix, preFix, dOBMin, dOBMax, gender, dateofDeathMin, dateofDeathMax, race);
        ...
        public async Task<long> GetCountAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetDbSetAsync()), filterText, mCPMember_IDMin, mCPMember_IDMax, lastName, firstName, mIddleName, suffix, preFix, dOBMin, dOBMax, gender, dateofDeathMin, dateofDeathMax, race);
